...
def help():
    ...
    helpMessage = "╔═════════════════\n╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】\n╚═════════════════\n「 " + key + " 」\n╔═════════════════\n" + \
                  ...
                  "╠ ✯͜͡❂ " + key + "Allbye\n" + \
                  "╠ ✯͜͡❂ " + key + "Byeme\n" + \
                  "╠ ✯͜͡❂ " + key + "Leave「Namagrup」\n" + \
                  "╠ ✯͜͡❂ " + key + "Ginfo\n" + \
                  "╠ ✯͜͡❂ " + key + "Open\n" + \
                  "╠ ✯͜͡❂ " + key + "Close\n" + \
                  "╠ ✯͜͡❂ " + key + "Url grup\n" + \
                  "╠ ✯͜͡❂ " + key + "Gruplist\n" + \
                  "╠ ✯͜͡❂ " + key + "Infogrup「angka」\n" + \
                  "╠ ✯͜͡❂ " + key + "Infomem「angka」\n" + \
                  "╠ ✯͜͡❂ " + key + "Remove chat\n" + \
                  "╠ ✯͜͡❂ " + key + "Lurking「on/off」\n" + \
                  "╠ ✯͜͡❂ " + key + "Lurkers\n" + \
                  "╠ ✯͜͡❂ " + key + "Sider「on/off」\n" + \
                  "╠ ✯͜͡❂ " + key + "Updatefoto\n" + \
                  "╠ ✯͜͡❂ " + key + "Updategrup\n" + \
                  "╠ ✯͜͡❂ " + key + "Updatebot\n" + \
                  "╠ ✯͜͡❂ " + key + "Broadcast:「Text」\n" + \
                  ...
                  "╠ ✯͜͡❂ " + key + "Lokasi:「Nama Kota」\n" + \
                  "╠ ✯͜͡❂ " + key + "Music:「Judul Lagu」\n" + \
                  "╠ ✯͜͡❂ " + key + "Lirik:「Judul Lagu」\n" + \
                  "╠ ✯͜͡❂ " + key + "Ytmp3:「Judul Lagu」\n" + \
                  "╠ ✯͜͡❂ " + key + "Ytmp4:「Judul Video」\n" + \
                  "╠ ✯͜͡❂ " + key + "Profileig:「Nama IG」\n" + \
                  "╠ ✯͜͡❂ " + key + "Profilesmule:「ID smule」\n" + \
                  "╠ ✯͜͡❂ " + key + "Cekdate:「tgl-bln-thn」\n" + \
                  "╠ ✯͜͡❂ " + key + "Jumlah:「angka」\n" + \
                  "╠ ✯͜͡❂ " + key + "Spamtag「@」\n" + \
                  ...
                  "╠ ✯͜͡❂ " + key + "Contact「on/off」\n" + \
                  "╠ ✯͜͡❂ " + key + "Autojoin「on/off」\n" + \
...
def helpbot():
    ...
    helpMessage1 = "╔═════════════════\n╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】\n╚═════════════════\n「 " + key + " 」\n╔═════════════════\n" + \
                  ...
                  "╠ ✯͜͡❂ " + key + "Cek respon \n" + \
                  "╠ ✯͜͡❂ " + key + "Cek welcome\n" + \
                  "╠ ✯͜͡❂ " + key + "Set sider:「Text」\n" + \
                  "╠ ✯͜͡❂ " + key + "Set spam:「Text」\n" + \
                  "╠ ✯͜͡❂ " + key + "Set pesan:「Text」\n" + \
                  "╠ ✯͜͡❂ " + key + "Set respon:「Text」\n" + \
                  "╠ ✯͜͡❂ " + key + "Set welcome:「Text」\n" + \
                  "╠ ✯͜͡❂ " + key + "Myname:「Nama」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot1name:「Nama」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot2name:「Nama」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot3name:「Nama」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot1up「Kirim fotonya」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot2up「Kirim fotonya」\n" + \
                  "╠ ✯͜͡❂ " + key + "Bot3up「Kirim fotonya」\n" + \
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                kk.sendText(msg.to, "Bye-bye semuanya yg ada di "+str(G.name))
                                kk.leaveGroup(msg.to)
                                kc.sendText(msg.to, "Bye-bye semuanya yg ada di "+str(G.name))
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                               cl.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】0\n"+cl.authToken)
                            ...
                            if msg._from in admin:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     cl.sendMessage(msg.to, "▶ MAXSY ◀ : %s" % str(group.name))
                                     group1 = ki.findGroupByTicket(ticket_id)
                                     ki.acceptGroupInvitationByTicket(group1.id,ticket_id)
                                     ki.sendMessage(msg.to, "BOT KICKER 1 : %s" % str(group.name))
                                     group2 = kk.findGroupByTicket(ticket_id)
                                     kk.acceptGroupInvitationByTicket(group2.id,ticket_id)
                                     kk.sendMessage(msg.to, "BOT KICKER 2 : %s" % str(group.name))
                                     group3 = kc.findGroupByTicket(ticket_id)
                                     kc.acceptGroupInvitationByTicket(group3.id,ticket_id)
                                     kc.sendMessage(msg.to, "BOT KICKER 3 : %s" % str(group.name))
